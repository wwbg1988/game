...
%> 
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/carte/umedit/third-party/jquery.min.js"></script>
...
<form id="form" method="post">
 <input id="newsid" name="newsid" type="hidden" value="${newsid}"/>
...
$(function() {
	...
	$('#form').form({
		url : '${pageContext.request.contextPath}/newsController/insertNewsInfo',
		onSubmit : function() {
