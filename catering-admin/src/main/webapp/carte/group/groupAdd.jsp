...
var projId='${deptDto.projId}';
	$(function() {
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/groupInfoController/insertGroupInfo',
			onSubmit : function() {
				/*var age = $("#age").val();
				if(age==''||isNaN(age)){
		...
		<form id="form" method="post">
			<table class="table table-hover table-condensed">
				...
				<tr>
				   <th>创建人</th>
				   <td>
				   <select id="createuserid" name="createuserid" class="easyui-combobox span2" data-options="width:140,height:32,editable:false,panelHeight:100"></select>
				   </td>
				</tr>
				<tr>
					<th>群信息</th>
