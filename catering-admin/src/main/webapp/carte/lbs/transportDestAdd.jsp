...
localSearch.enableAutoViewport(); //允许自动调节窗体大小
	$(function() {
		...
		$('#form')
				.form(
						{
							url : '${pageContext.request.contextPath}/transportDestController/add',
							onSubmit : function() {
	...
	function searchDestByStationName() {
...
<div class="easyui-layout" data-options="fit:true,border:false">
	...
	<form id="form" method="post">
			...
			<table class="table table-hover table-condensed">
				<tr>
					<td><input name="id" type="hidden" value="${transportDestDto.id}" />
				...
				<tr>
					...
					<td><input id="address" type="text" name="address"
						style="margin-right: 2px;" class="easyui-validatebox span2" />	<input type="button" value="查询经纬度" onclick="searchDestByStationName();"  class="easyui-linkbutton"/></td>
