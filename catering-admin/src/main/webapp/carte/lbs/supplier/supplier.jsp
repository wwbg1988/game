						...
						function(b) {
							if (b) {
								...
								if (currentUserId != id) {
									...
									$
											.post(
													'${pageContext.request.contextPath}/supplierController/delete',
													{
														id : id
													},
													function(result) {
				...
				.dialog(
						{
							...
							width : 650,
							height : 240,
							href : '${pageContext.request.contextPath}/supplierController/editPage?id='
									+ id,
							buttons : [ {
								text : '编辑',
								handler : function() {
									parent.$.modalDialog.openner_dataGrid = dataGrid;//因为添加成功之后，需要刷新这个dataGrid，所以先预定义好
									var f = $('#supplierMap').find(
											'#supplierForm');
									f.submit();
								}
							} ]
...
<body>
	<div class="easyui-layout" data-options="fit : true,border : false">
		...
		<div data-options="region:'center',border:false">
			<table id="sendataGrid" title="供应商信息列表" data-options="collapsible:true"></table>
		</div>
	</div>
