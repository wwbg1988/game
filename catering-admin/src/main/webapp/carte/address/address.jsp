							...
							columns : [ [
									...
									},
									{
										...
										formatter : function(value, row, index) {
											...
											str += $
													.formatString(
															'<img onclick="addAddressUserFun(\'{0}\');" src="{1}" title="添加区域负责人"/>',
															row.id,
															'${pageContext.request.contextPath}/style/images/extjs_icons/user/user_add.png');
											str += '&nbsp;&nbsp;&nbsp;';
											str += $
													.formatString(
															'<img onclick="deleteAddressUserFun(\'{0}\',\'{1}\');" src="{2}" title="删除区域负责人"/>',
															row.id,
															row.userId,
															'${pageContext.request.contextPath}/style/images/extjs_icons/user/user_delete.png');

											if ($.canCafeAdd && row.isLeaf == 1) {

												str += '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
												str += $
														.formatString(
																'<img onclick="findCafeAddress(\'{0}\',\'{1}\');" src="{2}" title="查看区域所属餐厅列表"/>',
																row.id,
																row.addressName,
																'${pageContext.request.contextPath}/style/images/extjs_icons/zoom/zoom.png');

												str += '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
												str += $
														.formatString(
																'<img onclick="addCafetoriumFun(\'{0}\');" src="{1}" title="添加食堂"/>',
																row.id,
																'${pageContext.request.contextPath}/style/images/extjs_icons/table/table_add.png');
												str += '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
												str += $
														.formatString(
																'<img onclick="addMeetingFun(\'{0}\');" src="{1}" title="添加会议室"/>',
																row.id,
