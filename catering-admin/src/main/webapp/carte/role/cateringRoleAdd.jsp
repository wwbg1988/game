...
<script type="text/javascript">
	$(function() {
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/cateringRoleController/insertRole',
			onSubmit : function() {
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		...
		<input id="projId" name="projId"  type="hidden" value="1959a627-1a89-4497-b1e4-144d019d6687"/>
