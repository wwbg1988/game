	...
	<div data-options="region:'center',border:false" title=""
		...
		<form id="form" method="post">
			<table class="table table-hover table-condensed">
				<tr style="display: none;">
					...
					<td><input name="id" type="text" class="span2"
						value="${comuuid.id}" readonly="readonly" style="width:160px;"></td>
				</tr>
				   <tr>
					<th>公司名称</th>
					<td><input name="companyName" type="text" style="width:140px;"
			...
			<%-- 	<tr>
				...
				<tr>
					<th>公司电话</th>
					<td><input name="mobileNo" type="text" style="width:140px;"
						class="easyui-validatebox span2" 
						data-options="required:false"></td>
				</tr>
				<tr>
					<th>公司邮箱</th>
					<td><input name="email" type="text" style="width:140px;"
						class="easyui-validatebox span2" 
						data-options="required:false"></td>
				</tr>
			 </table>
