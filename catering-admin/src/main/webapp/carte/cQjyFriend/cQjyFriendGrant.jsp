...
<script type="text/javascript">
	...
	$(function() {
		resourceTree = $('#resourceTree').tree({
			url : '${pageContext.request.contextPath}/cQjyFriendController/userTree',
			parentField : 'pid',
			//lines : true,
			checkbox : true,
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/cQjyFriendController/grantUsers',
			onSubmit : function() {
	...
	$("#searchNameBtn").click(function(){
		...
		resourceTree = $('#resourceTree').tree({
			url : '${pageContext.request.contextPath}/cQjyFriendController/userTree?searchName='+searchName,
			parentField : 'pid',
			//lines : true,
			checkbox : true,
			onClick : function(node) {
