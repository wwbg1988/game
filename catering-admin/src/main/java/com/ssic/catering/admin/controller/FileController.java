...
import com.ssic.catering.admin.comparator.NameComparator;
import com.ssic.catering.admin.comparator.SizeComparator;
import com.ssic.catering.admin.comparator.TypeComparator;
...
public class FileController extends BaseController {
	...
	public Map<String, Object> upload(HttpServletResponse response, HttpServletRequest request, HttpSession session) {
		...
		extMap.put("image", ConfigUtil.IMAGE);
		extMap.put("flash", ConfigUtil.FLASH);
		extMap.put("media", ConfigUtil.MEDIA);
		extMap.put("file", ConfigUtil.FILE);

		long maxSize = Long.parseLong(ConfigUtil.MAXFILESIZE); // 允许上传最大文件大小(字节)
