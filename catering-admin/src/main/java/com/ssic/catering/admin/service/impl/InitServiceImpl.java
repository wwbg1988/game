...
import com.ssic.catering.admin.dao.RoleDao;
import com.ssic.catering.admin.dao.UserDao;
import com.ssic.catering.admin.service.InitServiceI;
...
//		List<Tuser> l = userDao.find("from Tuser t where t.name in ('超管','admin1','admin2','admin3','admin4','admin5','guest')");
//		if (l != null && l.size() > 0) {
//		for (Tuser user : l) {
//				userDao.delete(user);
//			}
