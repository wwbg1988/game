...
/**		
 * <p>Title: UploadMController </p>
 * <p>Description: 类描述</p>
 * <p>Copyright (c) 2015 </p>
 * <p>Company: 上海天坊信息科技有限公司</p>
 * @author Administrator	
 * @date 2015年8月3日 下午4:45:33	
 * @version 1.0
 * <p>修改人：Administrator</p>
 * <p>修改时间：2015年8月3日 下午4:45:33</p>
 * <p>修改备注：</p>
 */
@Controller
@RequestMapping(value = "/http/api/ims/upload")
public class UploadMController
{
    ...
    @ResponseBody
    //注册用户
    public static Response<String> deal(String base64Img) {
        
         String uploadFileUrl="/upload/upload/";
...
//            System.out.println("---------"+b.length);
            ...
            //生成jpeg图片
            String fileName = new Date().getTime()+".jpg";//新生成的图片
            String filePath = rootPath.append("/").append(fileName).toString();
            OutputStream out = new FileOutputStream(filePath);    
            out.write(b);
            out.flush();
            out.close();
            
            String uploadPath = "/upload/"+fileDe+"/"+fileName;
...
//            System.out.println(filePath+"---"+uploadPath);
    ...
    */
    ...
    @ResponseBody
    //注册用户
    public Response<String> deal(String base64Img, HttpSession session) {
        ...
        result.setData(realPath.substring(rootPath.length()+1));
        return result;
    }
