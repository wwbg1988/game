...
<script type="text/javascript">
	...
	$(function() {
		resourceTree = $('#resourceTree').tree({
			url : '${pageContext.request.contextPath}/ProjectController/userTree?projId='+$("#ids").val(),
			parentField : 'pid',
			//lines : true,
			checkbox : true,
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/ProjectController/grantUsers',
			onSubmit : function() {
	...
	$("#searchNameBtn").click(function(){
		...
		resourceTree = $('#resourceTree').tree({
			url : '${pageContext.request.contextPath}/ProjectController/userTree?searchName='+searchName+'&projId='+$("#ids").val(),
			parentField : 'pid',
			//lines : true,
			checkbox : true,
			onClick : function(node) {
