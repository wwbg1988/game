...
<script type="text/javascript">
	...
	$(function() {
		resourceTree = $('#resourceTree').tree({
			url : '${pageContext.request.contextPath}/imsRoleController/userTree',
			parentField : 'pid',
			//lines : true,
			checkbox : true,
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/imsRoleController/grantUsers',
			onSubmit : function() {
	...
	$("#searchNameBtn").click(function(){
		...
		resourceTree = $('#resourceTree').tree({
			url : '${pageContext.request.contextPath}/imsRoleController/userTree?searchName='+searchName,
			parentField : 'pid',
			//lines : true,
			checkbox : true,
			onClick : function(node) {
