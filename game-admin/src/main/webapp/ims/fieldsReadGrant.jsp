		...
		<form id="readForm" method="post">
			<table class="table table-hover table-condensed">
				 <tr>
					...
					<th>所属角色</th>
					<td><select id="readRole" name="readRole" style="width: 140px; height: 29px;"></select><img src="${pageContext.request.contextPath}/style/images/extjs_icons/cut_red.png" onclick="$('#readRole').combotree('clear');" /></td>
				</tr> 
			</table>
		</form>
	</div>
