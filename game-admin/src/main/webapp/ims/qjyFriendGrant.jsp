...
<script type="text/javascript">
	...
	$(function() {
		resourceTree = $('#resourceTree').tree({
			url : '${pageContext.request.contextPath}/qjyFriendController/userTree',
			parentField : 'pid',
			//lines : true,
			checkbox : true,
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/qjyFriendController/grantUsers',
			onSubmit : function() {
	...
	$("#searchNameBtn").click(function(){
		...
		resourceTree = $('#resourceTree').tree({
			url : '${pageContext.request.contextPath}/qjyFriendController/userTree?searchName='+searchName,
			parentField : 'pid',
			//lines : true,
			checkbox : true,
			onClick : function(node) {
