...
<script type="text/javascript">
	$(function() {
		...
		$('#roleIds').combotree({
			url : '${pageContext.request.contextPath}/imsRoleController/tree?userId='+$("#userId").val(),
			parentField : 'pid',
			lines : true,
			panelHeight : 'auto',
			multiple : true,
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/imsUserController/grant',
			onSubmit : function() {
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		<form id="form" method="post">
		    <input  id="userId" name="userId"  type="hidden" value="${ids}"/> 
