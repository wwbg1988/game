...
<script type="text/javascript">
	...
	$(function() {
		resourceTree = $('#resourceTree').tree({
			url : '${pageContext.request.contextPath}/tImsProcessController/userTree?projId='+$("#projId").val(),
			parentField : 'pid',
			//lines : true,
			checkbox : true,
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/tImsProcessController/grantUsers',
			onSubmit : function() {
	...
	$("#searchNameBtn").click(function(){
		...
		resourceTree = $('#resourceTree').tree({
			url : '${pageContext.request.contextPath}/tImsProcessController/userTree?searchName='+searchName+'&projId='+$("#projId").val(),
			parentField : 'pid',
			//lines : true,
			checkbox : true,
			onClick : function(node) {
...
<div id="roleGrantLayout" class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'west'" title="用户列表" style="width: 350px; padding: 1px;">
