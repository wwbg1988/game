	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		<form id="form" method="post">
			...
			<table class="table table-hover table-condensed">
			    ...
			    <tr>
			        <th>项目名称</th>
					<td><input id="projName" name="projName" value="${pDto.projName}" type="text" placeholder="请输入项目名称" class="easyui-validatebox span2" data-options="required:true" style="width:267px;"></td>
			        <th></th>
			        <td>&nbsp;</td>
			    </tr>
			    <tr>
